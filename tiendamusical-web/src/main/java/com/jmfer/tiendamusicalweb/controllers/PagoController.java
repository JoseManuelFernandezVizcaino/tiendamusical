...
import com.jmfer.tiendamusicalservices.client.ReportesServiceClient;
 ...
 * Controla el flujo de la compra realizada por el cliente.
 */
@ManagedBean
@ViewScoped
public class PagoController {
	...
	public void guardarFactura() {
		...
		//Si se generó la factura en la base de datos 
		if (facturaGenerada != null) {
			...
			boolean productosCarritoActualizados = this.carritoServiceImpl.actualizarCarritoAlbum(persona.getCarrito().getCarritosAlbum(), facturaGenerada);
			...
			CommonUtils.mostrarMensaje(FacesMessage.SEVERITY_ERROR, "ERROR!", "No se generó la factura");
		}
	}
